...
def _response(record: TaskRecord) -> TaskResponse:
    return TaskResponse(
        ...
        planned_lane_number_from_right=record.planned_lane_number_from_right,
        planned_clearance_threshold_m=record.planned_clearance_threshold_m,
        planned_clearance_upper_limit_m=record.planned_clearance_upper_limit_m,
        travel_direction=record.travel_direction,
        lane_side=record.lane_side,
        lane_number_from_right=record.lane_number_from_right,
        lane=record.lane,
        lidar_mount_height_m=record.lidar_mount_height_m,
        clearance_threshold_m=record.clearance_threshold_m,
        clearance_upper_limit_m=record.clearance_upper_limit_m,
