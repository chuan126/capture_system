...
```json
{
  ...
  "localization_heading_fit_sample_count": 21,
  "localization_heading_fit_baseline_m": 105.0,
  "localization_heading_fit_rmse_m": 2.5,
  "localization_heading_fit_p95_residual_m": 4.8,
  "localization_heading_fit_inlier_ratio": 0.95,
  "localization_heading_fit_delta_yaw_deg": 12.5,
  "localization_heading_fit_valid": true,
...
- 融合定位栏只显示推算纬度、经度、高度、车辆俯仰/横滚和实际车向；实际车向与地图小车一致，原始RTK有效时取 `track_degrees`，否则取 `localization_heading_deg`；
