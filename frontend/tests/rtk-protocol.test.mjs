...
test("parses an indoor no-fix RTK snapshot without adding quality fields", () => {
  const snapshot = parseRtkText(JSON.stringify({
    ...
    localization_heading_fit_sample_count: 0,
    localization_heading_fit_baseline_m: 0,
    localization_heading_fit_rmse_m: 0,
    localization_heading_fit_p95_residual_m: 0,
    localization_heading_fit_inlier_ratio: 0,
    localization_heading_fit_delta_yaw_deg: 0,
    localization_heading_fit_valid: false,
    localization_heading_fit_window_span_m: 0,
    localization_heading_error_before_deg: 0,
    localization_heading_error_after_deg: 0,
    localization_simulation_test_mode: 1,
    localization_simulation_progress_percent: 0,
...
test("rejects malformed RTK numeric fields", () => {
  assert.throws(
    () => parseRtkText(JSON.stringify({
      ...
      localization_heading_fit_sample_count: null,
      localization_heading_fit_baseline_m: null,
      localization_heading_fit_rmse_m: null,
      localization_heading_fit_p95_residual_m: null,
      localization_heading_fit_inlier_ratio: null,
      localization_heading_fit_delta_yaw_deg: null,
      localization_heading_fit_window_span_m: null,
      localization_heading_error_before_deg: null,
      localization_heading_error_after_deg: null,
      localization_simulation_test_mode: null,
      localization_simulation_progress_percent: null,
      ...
      localization_heading_fit_valid: null,
