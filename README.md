...
激光雷达和 RTK，在设备端完成原始雷达本体系最低可信点簇检测、旁路点云补偿、状态监控和
局域网网页展示。
...
网页点云预览仍从补偿后的局部东北天点云分出独立显示旁路。预览节点只在有网页消费者时处理
...
- 局部东北天点云的 5 Hz、最多 10,000 点 PCV2 蓝/绿/红旁路网页预览。
...
- `localization` 只保留运动补偿预览旁路复用的姿态数学库，不再发布融合定位 Topic。
...
- [姿态公共库边界](ros2_ws/src/localization/README.md)
